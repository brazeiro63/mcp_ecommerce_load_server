...
from src.app.schemas.affiliate_store import AffiliateStoreInDB
...
def discover_stores(
    ...
    try:
        ...
        research_stores = ResearchStores()
        selection_crew = research_stores.store_selection_crew()
        
        raw_output = selection_crew.kickoff(inputs=inputs)
